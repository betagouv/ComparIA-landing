<script lang="ts">
  ...
  const options = [
    { value: 'light', label: m['footer.theme.options.light'](), imgSrc: lightPictoSrc },
    { value: 'dark', label: m['footer.theme.options.dark'](), imgSrc: darkPictoSrc },
    {
      value: 'system',
      label: m['footer.theme.options.system'](),
      subLabel: m['footer.theme.options.systemSub'](),
